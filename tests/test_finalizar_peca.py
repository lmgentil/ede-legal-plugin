...
def test_pipeline_completo_ok_contra_modelo_oficial_real(modelo_oficial_local):
    entrada = {
...
@pytest.mark.docx_real
def test_pipeline_nunca_gera_arquivo_temporario_residual(modelo_oficial_local):
    import glob
    import tempfile
